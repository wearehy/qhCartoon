...
class BuildGridView extends StatelessWidget {
  ...
  Container buildGridViewChild(BuildContext context, CartoonIndexHomeList e, aspectRatio) {
    //网格子组件
    return Container(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: GridView.count(
        ...
        children: list.map((e) => buildGridViewChild(context, e, aspectRatio)).toList(),
      ),
    );
  }
}
